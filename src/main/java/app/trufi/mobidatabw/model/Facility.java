...
public class Facility {
	...
	public String toString() {
		return "Facility{" + "equipmentNumber=" + equipmentnumber + ", type=" + type + ", description='" + description + '\'' + ", geocoordX="
				+ geocoordX + ", geocoordY=" + geocoordY + ", state=" + state + ", stateExplanation='" + stateExplanation + '\'' + ", stationnumber="
				+ stationnumber + (operatorName != null ? ", operatorName='" + operatorName + '\'' : "")+ '}';
	}
}
